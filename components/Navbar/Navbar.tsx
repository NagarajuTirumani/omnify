...
import logo from "@/public/mainIcon.svg";
...
import navigationIcon from "@/public/secondary icon.svg";
import profileIcon from "@/public/profile.svg";
import helpCircleIcon from "@/public/help-circle.svg";
      ...
      <div className={`flex flex-col ${appData?.collapse ? 'px-2' : 'px-6'}`}>
        ...
        <div className={`flex items-center cursor-pointer ${appData?.collapse ? 'justify-center' : 'justify-between'} py-6`}>
          ...
          {appData?.collapse ? null : (
            <div
              className="border-[#64748B] border-[1px] border-solid w-[12px] h-[12px] rounded-sm flex justify-end cursor-pointer"
        ...
        <div className="flex flex-col w-full">
          <div
            className={`w-full items-center rounded-md bg-white flex ${
              appData?.collapse
                ? `p-2 justify-center`
